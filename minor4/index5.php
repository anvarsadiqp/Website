	...
	<div id="header" class="container">
		<div id="logo">
		 <?php
					...
					$extract=mysql_query("select url from logo where id=1");
...
if(!empty($username1)&&!empty($password1)){
    ...
    if($count==1){
        ...
        header('Location:http://localhost/minor4/indx51.php');
	}
    else {;
...
<div id="popupbox"> 
	<div id="container">
		...
		<input type="name" name="username1" id="username1" required="required">
		<div id="use"></div>
		...
		<input type="submit" value="Login" name="submit1" id="submitl" onChange="checkform()">
...
?>
		...
		<input type="submit" id="submitt" value="submit" name="submit">
